...
end, { desc = "Toggle Line Wrap and Line Break" })
...
-- Easy remove tabs
map("n", "<leader>si", ":%s/\t/    /g", { desc = "Changes '\t' to 4 spaces" })
...
-- Using bash to not have 2 vim modes at the same time when using zsh

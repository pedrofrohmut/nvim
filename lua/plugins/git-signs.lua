...
cmd("GSStageHunk", function() gs.stage_hunk() end, { desc = "Stage hunk" })
cmd("GSResetHunk", function() gs.reset_hunk() end, { desc = "Reset hunk" })
...
-- View Diff
cmd("GSDiff", function() gs.diffthis() end, { desc = "Diff this" })
